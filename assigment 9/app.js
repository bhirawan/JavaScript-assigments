...
var students=['Saira','Samina','Tahira'];
...
document.write('Score of  '+students[2]+' is  '+score[2]+' . Percentage: '+percentage3+' % '+'<br>'+ '<br>')
...
var citynames=['Karachi','Lahore','Quetta','Multan','Peshawar','Dunyapur'];
...
// 14. Create a new array. Store values one by one in such a way that 

//  you can access the values in reverse order. (last In First Out)
